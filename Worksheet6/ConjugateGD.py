...
#     # x1 = x1_value
#     # x2 = x2_value
#     # # position = -x1*x2*(-1.5*m.exp(-x1**2 + 3*x1 - x2**2 + 6*x2 - 14) + 3*m.sin(m.sqrt(x1**2 + x2**2)))/((x1**2 + x2**2)**(3/2)*m.sqrt(-x2**2/(x1**2 + x2**2) + 1)) + (3*x1*m.cos(m.sqrt(x1**2 + x2**2))/m.sqrt(x1**2 + x2**2) - 1.5*(3 - 2*x1)*m.exp(-x1**2 + 3*x1 - x2**2 + 6*x2 - 14))*m.asin(x2/m.sqrt(x1**2 + x2**2))
#     # position = x2*cos(x1+x2)
#     # return position
#
...
#     # x1 = x1_value
#     # x2 = x2_value
#     # position = (-x2**2/(x1**2 + x2**2)**(3/2) + 1/m.sqrt(x1**2 + x2**2))*(-1.5*m.exp(-x1**2 + 3*x1 - x2**2 + 6*x2 - 14) + 3*m.sin(m.sqrt(x1**2 + x2**2)))/m.sqrt(-x2**2/(x1**2 + x2**2) + 1) + (3*x2*m.cos(m.sqrt(x1**2 + x2**2))/m.sqrt(x1**2 + x2**2) - 1.5*(6 - 2*x2)*m.exp(-x1**2 + 3*x1 - x2**2 + 6*x2 - 14))*m.asin(x2/m.sqrt(x1**2 + x2**2))
#     # return position
...
def conjugateGradientDescent():
    ...
    while(True):
        ...
        if(abs(gradient_d_k_plus1[0])<=0.001 and abs(gradient_d_k_plus1[1])<=0.001):
